    ...
    <section class="bg-white light:bg-gray-900 rounded-md">
      <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
        <div class="mx-auto max-w-screen-sm text-center lg:mb-16 mb-8">
          <h2 class="mb-4 text-3xl lg:text-4xl tracking-tight font-extrabold text-gray-900 light:text-white">
            Our Blog
          </h2>
        ...
        <div class="grid gap-8 lg:grid-cols-2">
          {blogsData.slice(0, visibleBlogs).map((blog, index) => (
            <article
              key={index}
              class="p-6 bg-white rounded-lg border border-gray-200 shadow-md light:bg-gray-800 light:border-gray-700"
            >
              <div class="mb-4">
                <img
              ...
              <div class="flex justify-between items-center">
                <div className="flex items-center space-x-4">
                  ...
                  />
                  <span class="font-medium light:text-white">
                    {business?.first_name}
                  </span>
                </div>
                <div
                  onClick={() => blogDetail(blog)}
                  class="cursor-pointer inline-flex items-center font-medium text-primary-600 light:text-primary-500 hover:underline"
                >
                  Read more
                  <svg
                    class="ml-2 w-4 h-4"
