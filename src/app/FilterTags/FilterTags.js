              ...
              businesses.length > 0 ? (
                <div className="w-[90%] lg:w-[1170px] mx-auto py-[60px]">
                  ...
                  <h2 className="text-2xl font-bold text-center mb-8 ">
                    ...
                    {tagData
                      ? businesses[0]?.business_tags?.find((tag) => tag.value === tagData?._id)?.label
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {businesses?.map((business) => (
                      <div key={business.id}>
                        <div onClick={() => navigate(`${middleware}${business.slug}`)} className="relative mx-auto cursor-pointer !w-[330px] !h-[390px] rounded-xl overflow-hidden shadow-sm border">
                          ...
                          <div className="p-4 cursor-pointer" >
                            ...
                            <div className="scrollable-container">
                              {business?.business_tags?.map((tag, index) => (
                                <h3 key={index} className="bg-white w-fit px-[10px] my-2 py-1 rounded-md border font-bold">
                                  {/* {tag?.label} */}
                                  {tag?.label?.length > 25 ? `${tag.label.slice(0, 25)}...` : tag.label}
                                </h3>
                              ))}
                            </div>
                          </div>
